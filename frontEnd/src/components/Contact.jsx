        ...
        <main className="flex flex-col items-center justify-items-center">
            <h1 className="text-white font-bold text-4xl font-serif">Contact</h1>
                <div className="flex flex-col items-center">
                    <h2 className="text-white font-bold text-2xl font-serif mt-8">Phone Number: 210-633-7867</h2>
                    <h2 className="text-white font-bold text-2xl font-serif mt-4">Email: dragos.moonwalks@yahoo.com</h2>
